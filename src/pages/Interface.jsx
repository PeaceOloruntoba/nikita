  ...
  return (
    <div className="flex flex-col w-full items-center justify-center gap-8 p-8">
      ...
      <div className="flex items-center justify-center gap-8 w-full">
        <button className="flex flex-col w-full -start">
          <span className="w-f text-lg font-semibold">Food Menu</span>
          <img src={menu} alt="" className="w-full rounded-2xl h-44" />
        </button>
        <button className="flex flex-col w-full -start">
          <span className="w-f text-lg font-semibold">Wine Menu</span>
          <img src={menu} alt="" className="w-full rounded-2xl h-44" />
        </button>
      </div>
    </div>

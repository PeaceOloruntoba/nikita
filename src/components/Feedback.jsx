...
export function FeedbackCard({ card }) {
  return (
    <div
      className="p-6 rounded-lg flex flex-col w-full  items-center justify-between bg-white text-[#EDEDED]"
      key={card?.id}
    >
      <div className="flex items-center justify-between py-2 w-full">
        <span className="text-[#3a3a3a]/70 text-2xl font-medium">
      ...
      <span className="text-[#3a3a3a]/30">{card?.feedback}</span>
    </div>
  );
}
